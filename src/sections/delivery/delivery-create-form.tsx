...
export default function DeliveryCreateForm({ open, onClose }: Props) {
      ...
      <FormProvider methods={methods} onSubmit={() => console.log('click')}>
        ...
        <DialogContent>
          <Box rowGap={3} columnGap={2} display="grid" sx={{ pt: 1 }}>
            <RHFTextField name="delivery" label="Yetkazib beruvchi" />
            <RHFTextField name="phone" label="Telefon nomer" />
            <RHFTextField name="address" label="Manzil" />
            <RHFTextField name="comment" label="Izoh" multiline rows={4} />
          </Box>
        </DialogContent>

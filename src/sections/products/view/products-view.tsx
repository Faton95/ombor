...
import UserTableRow from '../products-table-row';
import UserCreateForm from '../products-create-form';
...
const TABLE_HEAD = [
  { id: 'N', label: '№', width: 20 },
  { id: 'products', label: 'Mahsulotlar', width: 500 },
  { id: 'category', label: 'Kategoriyasi', width: 300 },
  { id: 'measurements', label: 'O\'lchov birligi', width: 300 },
  { id: '', width: 10 },
];
